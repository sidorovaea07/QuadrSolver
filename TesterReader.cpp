/*!
    \file 
    \brief Tester and Reader module
*/
...
struct SolverData HandMadeTests[] = {
        { 1, -5, 6, TwoRoots, 3, 2},
        { 1, 0, -4, TwoRoots, 2, -2},
...
{
    struct SolverData Real = {Ref.a, Ref.b, Ref.c, NANRoots, NAN, NAN};
    SquareSolv(&Real);
...
int TestsReader() {
    struct SolverData Tests = {NAN, NAN, NAN, NANRoots, NAN, NAN};
    int passed = 0;
